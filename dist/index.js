...
exports.findChangedFiles = void 0;
...
function findChangedFiles(patterns, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const micromatchOptions = Object.assign(Object.assign({}, defaultOptions), options);
        const paths = status.files.map(file => {
        ...
        const matches = (0, micromatch_1.default)(paths, patterns, micromatchOptions);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.validateOutputInput = exports.toList = exports.validatePatternsInput = void 0;
function validatePatternsInput(input) {
    if (!input) {
        throw new Error(`The action must be given an input named "patterns" with either a single pattern as a string or a multiline string list of patterns`);
    }
    return input;
}
exports.validatePatternsInput = validatePatternsInput;
...
function validateOutputInput(input, defaultOutput = 'string') {
    if (!input) {
        return defaultOutput;
    }
    const validValues = ['string', 'array'];
    if (!validValues.includes(input)) {
        throw new Error(`Variable "output" must be one of ${validValues}`);
    }
    return input;
}
exports.validateOutputInput = validateOutputInput;
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const patterns = (0, input_validation_1.toList)((0, input_validation_1.validatePatternsInput)(core.getInput('patterns', { required: true })));
            core.debug(`Got "patterns" ${patterns}`);
            const ignore = (0, input_validation_1.toList)(core.getInput('ignore'));
            if (ignore) {
                core.debug(`Got "ignore" ${ignore}`);
            }
            const output = (0, input_validation_1.validateOutputInput)(core.getInput('output'));
            core.debug(`Got "output" ${output}`);
            const paths = yield (0, git_1.findChangedFiles)(patterns, { ignore });
